...
class Product(Base):
    ...
    orders = relationship("Order", secondary="einkaufskorb", back_populates="products")
...
class Einkaufskorb(Base):
    ...
    order = relationship("Order", backref="einkaufskorb")
    product = relationship("Product", backref="einkaufskorb")
